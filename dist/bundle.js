...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_accordion__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_helloworld__ = __webpack_require__(458);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_mouseEvent__ = __webpack_require__(459);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_api__ = __webpack_require__(460);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_array__ = __webpack_require__(461);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_input__ = __webpack_require__(462);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_promise__ = __webpack_require__(463);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_callback__ = __webpack_require__(464);
...
Object(__WEBPACK_IMPORTED_MODULE_1__components_helloworld__["a" /* runHelloWorld */])();
Object(__WEBPACK_IMPORTED_MODULE_5__components_input__["a" /* runInput */])();
Object(__WEBPACK_IMPORTED_MODULE_2__components_mouseEvent__["a" /* runMouseEvent */])();
Object(__WEBPACK_IMPORTED_MODULE_3__components_api__["a" /* runApiExample */])();
Object(__WEBPACK_IMPORTED_MODULE_4__components_array__["a" /* runArrayExample */])();
Object(__WEBPACK_IMPORTED_MODULE_6__components_promise__["a" /* runPromise */])();
Object(__WEBPACK_IMPORTED_MODULE_7__components_callback__["a" /* runCallback */])();
Object(__WEBPACK_IMPORTED_MODULE_0__components_accordion__["a" /* initAccordion */])();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_render__ = __webpack_require__(12);
...
const subscribeAccordion = () => {
  const accordionHeader = document.querySelectorAll(".example__title");
  const accordionObservable = __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx___default.a.Observable.fromEvent(accordionHeader, "click");
...
const initAccordion = () => {
  Object(__WEBPACK_IMPORTED_MODULE_0__utils_render__["a" /* default */])(ACCORDION_ID, accordionTemplate);
  subscribeAccordion();
};
...
const subscribeHelloWorld = () => {
    const observable = __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx___default.a.Observable.create(observer => {
        observer.next('Hello World');
    });
...
const runHelloWorld = () => {
    Object(__WEBPACK_IMPORTED_MODULE_0__utils_render__["a" /* default */])(HELLOWORLD_ID, helloWorldTemplate);
    subscribeHelloWorld();
};
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return runApiExample; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_render__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_rxjs_Rx__);
...
const subscribeApi = () => {
    ...
    const requests$ = __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx___default.a.Observable.fromEvent(btnViewGenres, 'click').map(_ => 'https://api.themoviedb.org/3/genre/movie/list?api_key=76f6b14f3a0fd2ed9f79af9b6db27612&language=en-US');
    const responses$ = requests$.flatMap(url => __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx___default.a.Observable.fromPromise(fetch(url))).flatMap(r => __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx___default.a.Observable.fromPromise(r.json()));
    const genres$ = responses$.map(response => response.genres);
...
const runApiExample = () => {
    Object(__WEBPACK_IMPORTED_MODULE_0__utils_render__["a" /* default */])(API_ID, apiTemplate);
    subscribeApi();
};
...
const runArrayExample = () => {
  Object(__WEBPACK_IMPORTED_MODULE_0__utils_render__["a" /* default */])(ARRAY_ID, arrayTemplate);
  subscribeArray();
};
...
const subscribeInput = () => {
    ...
    const inputObservable = __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx___default.a.Observable.fromEvent(input, "input");
    inputObservable.map(({ target: { value } }) => ({
        value: !value ? '-' : value,
...
const runInput = () => {
    Object(__WEBPACK_IMPORTED_MODULE_0__utils_render__["a" /* default */])(INPUTEVENT_ID, inputTemplate);
    subscribeInput();
};
...
const subscribeCallback = () => {
    ...
    const boundSelectMeal = __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx___default.a.Observable.bindCallback(selectMeal);
    const boundSelectJuice = __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx___default.a.Observable.bindCallback(selectJuice);

    const mealSelector = document.getElementById('meal-selector');
    const juiceSelector = document.getElementById('juice-selector');

    __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx___default.a.Observable.fromEvent(mealSelector, 'change').map(({ target: { options, selectedIndex } }) => options[selectedIndex].value).subscribe(newMeal => {
        meal = newMeal;
        selectMeal(appendFoodToMenu);
        const mealObservable = boundSelectMeal();
    ...
    __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx___default.a.Observable.fromEvent(juiceSelector, 'change').map(({ target: { options, selectedIndex } }) => options[selectedIndex].value).subscribe(newJuice => {
        juice = newJuice;
...
const runCallback = () => {
    Object(__WEBPACK_IMPORTED_MODULE_0__utils_render__["a" /* default */])(CALLBACK_ID, callbackTemplate);
    subscribeCallback();
};
